  ...
  <div>
    ...
    <div class="commodity">
      ...
      <div class="comm-con">
        ...
        <div class="commodity-int">
          <div class="commodity-nam">
            <a href="#">汉米尔顿(Hamilton)卡其海军先锋系列 自动机械男表H78465553</a>
          </div>
          <div class="commodity-style">
            <span>颜色：银盘 棕带</span>
          </div>
          <div class="commodity-prize">
            <span>¥5599.00</span>
          </div>
    ...
    <div class="balance">
      ...
      <div class="balance-button">
        <a href="write-order.html">结算(3)</a>
      </div>
    </div>
  </div>
  <!-- 商品结算 -->
